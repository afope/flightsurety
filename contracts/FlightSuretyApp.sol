...
contract FlightSuretyApp {
    ...
    external payable
    {
        ...
        flightSuretyData.registerInsurance(msg.sender, flight, msg.value, payoutAmount);
...
contract FlightSuretyData {
    ...
    function registerInsurance(address passenger, string flight, uint256 amount, uint256 payoutAmount)
    view
    {}
